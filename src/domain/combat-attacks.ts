import { COMBAT_FORMULAS, MAX_ENCOUNTER } from "./combat-balance";
import type { AttackCommand, AttackResult, CombatState } from "./combat-contracts";
import { spawnEnemy } from "./combat-progression";
import {
